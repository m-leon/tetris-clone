...
public class Log {
    ...
    static public void error (Throwable ex) {
        if (ERROR) logger.log(LEVEL_ERROR, null, "", ex);
    }
    ...
    static public void warn (Throwable ex) {
        if (WARN) logger.log(LEVEL_WARN, null, "", ex);
    }
    ...
    static public void info (Throwable ex) {
        if (INFO) logger.log(LEVEL_INFO, null, "", ex);
    }
    ...
    static public void debug (Throwable ex) {
        if (DEBUG) logger.log(LEVEL_DEBUG, null, "", ex);
    }
    ...
    static public void trace (Throwable ex) {
        if (TRACE) logger.log(LEVEL_TRACE, null, "", ex);
    }
